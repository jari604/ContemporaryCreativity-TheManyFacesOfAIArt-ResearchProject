...
<template>
    <div class="p-5 max-w-prose text-justify">
      <FwbHeading tag="h5" class="text-2xl font-bold tracking-tight text-gray-900">
        Deelname aan onderzoek
      </FwbHeading>
      <FwbP class="font-normal text-gray-700">Beste deelnemer,</FwbP>
      ...
      <FwbP class="font-normal text-gray-700">
        ...
        u het meest <strong class="font-semibold text-gray-900"> nieuw, verrassend of waardevol</strong> vindt. Dit
      ...
      <FwbP class="font-normal text-gray-700">
        ...
        stemmen volledig anoniem zijn, kunnen ze niet aan u worden gekoppeld, waardoor het onmogelijk is om 'uw' stemmen
        te verwijderen na het indienen.
      </FwbP>
      ...
      <FwbP class="font-normal text-gray-700">Hartelijk dank voor uw tijd en deelname,</FwbP>
      <FwbP class="font-normal text-gray-700">Jari de Keijzer</FwbP>
